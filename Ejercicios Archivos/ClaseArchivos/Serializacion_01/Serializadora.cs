    ...
    public static class Serializadora
    {
        ...
        public static void Escribir(Personaje pj)
        {
            ...
            try
            {
                ...
                {
                    XmlSerializer xmlSerializer = new XmlSerializer(typeof(Personaje)); //Serializamos un objeto en especifico. El tipo Personaje.
                    xmlSerializer.Serialize(sw, pj); // aca serializamos.
                }
        ...
        public static Personaje Leer()
        {
            ...
            try
            {
                ...
                using (StreamReader sw = new StreamReader(completa))
                {
                    ...
                    pj = xmlSerializer.Deserialize(sw) as Personaje; //Deserialize devuelve un object, por lo que hay que castear al objeto que quiero.
                }
